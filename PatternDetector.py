...
ru_patterns = [set(['такие', 'как']), set(['таких', 'как']), set(['такими', 'как']), set(['таким', 'как']), set(['включая']), set(['особенно']), set(['и', 'другие']), set(['и', 'других']), set(['и', 'другими']), set(['и', 'другим']), set(['в', 'частности'])]
...
pattern_descriptors = set(['P1','P1_nomn','P1_gent_accs_loct','P1_datv','P1_ablt','P2','P3','P4','P4_nomn','P4_gent_accs_loct','P4_datv','P4_ablt','P5','P6'])
